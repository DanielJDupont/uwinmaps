...
import { updateEvent, createEvent, cancelToggle } from "../ClassroomActions";
  ...
  onFormSubmit = async values => {
    ...
    try {
      if (this.props.initialValues.id) {
        ...
        this.props.history.push(`/classrooms/${this.props.initialValues.id}`);
      } else {
        let createdEvent = await this.props.createEvent(values);
        this.props.history.push(`/classrooms/${createdEvent.id}`);
      }
    } catch (error) {
      console.log(error);
    }
          ...
          <Segment>
            ...
            >
              ...
              <Button
                ...
                onClick={
                  initialValues.id
                    ? () => history.push(`/classrooms/${initialValues.id}`)
                    : () => history.push("events")
                }
                type="button"
              >
